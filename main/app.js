'use strict';
import {fetchData,url} from "..assets/js/app.js";
import { getDate } from "../assets/js/module";
    ...
    searchTimeOut=setTimeout(()=>{
        fetchData(url.geo(searchField.value),function(locations){
            ...
            <li class="view-item">
                ...
                <div>
                    <p class="item-title">Kolkata</p>
                    <p class="label-2 item-subtitle">City of Kolkata,IN</p>
                </div>
            ...
            <div class="highlight-list">
                    ...
                    <div class="wrapper">
                        ...
                        <ul class="card-list">
                            ...
                            <li class="card-item">
                                ...
                                <p class="label-1">PM <sup>2.5</sup></p>
                            </li>
                            <li class="card-item">
                ...
                <div class="card card-sn highlight-card two">
                    ...
                    <div class="card-list">
                        <div class="card-item">
                            ...
                            <p class="title-1">${module.getTime(sunriseUnixUTC,timezone)}</p></div>
                        </div>
                        <div class="card-item">
                            <span class="m-icon">clear_night</span>
                            <div><p class="label-1">Sunset</p>
                            <p class="title-1">${module.getTime(sunsetUnixUTC,timezone)}</p></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-sn highlight-card">
                    ...
                    <div class="wrapper">
                        ...
                        <p class="title-1"></p>${parseInt(feels_like)}&deg;<sup>c</sup></p>
                    </div>
                </div>
            </div>
        `;
